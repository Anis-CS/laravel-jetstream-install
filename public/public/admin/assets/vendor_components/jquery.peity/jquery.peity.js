...
(function($, document, Math, undefined) {
  ...
  var svgElement = PeityPrototype.svgElement = function(tag, attrs) {
    return $(
      document.createElementNS('../../../../../external.html?link=http://www.w3.org/2000/svg', tag)
    ).attr(attrs)
  }
  ...
  peity.register(
    ...
    function(opts) {
      ...
      if (opts.delimiter == "../../../../../external.html?link=https://ev-admin-dashboard-template.multipurposethemes.com/") {
        var v1 = values[0]
        var v2 = values[1]
